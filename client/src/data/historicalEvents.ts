...
export const ARCHIVE_TOPICS: ArchiveTopic[] = [
  ...
  { id:"korean_war", title:"朝鲜战争", subtitle:"冷战冲突与半岛分裂", period:"1950-1953", region:"朝鲜半岛", description:"一场冷战背景下的半岛战争，其起因、过程与记忆被不同区域和国际行动者持续解释。", coverImage:"/images/korean_war-cover.jpg", caseId:"KW-1950", events: ALL_EVENTS.filter(e => e.topicId === "korean_war") },
  { id:"mongol_empire", title:"蒙古帝国的扩张", subtitle:"草原权力与欧亚变局", period:"1206-1368", region:"欧亚大陆", description:"草原帝国的迅速崛起重塑了欧亚外交、战争、贸易与跨文化交流。", coverImage:"/images/mongol_empire-cover.jpg", caseId:"MGE-1206-1368", events: ALL_EVENTS.filter(e => e.topicId === "mongol_empire") },
  ...
  { id:"renaissance", title:"文艺复兴", subtitle:"古典复兴、人文主义与艺术革命", period:"14-17世纪", region:"意大利及欧洲", description:"发端于意大利并波及全欧的文化运动，以人文主义、古典复兴和艺术创新为标志，推动了欧洲从中世纪向近代的转型，深刻影响了科学、政治和宗教改革。", coverImage:"/images/renaissance-cover.jpg", caseId:"REN-14C-17C", events: ALL_EVENTS.filter(e => e.topicId === "renaissance") },
