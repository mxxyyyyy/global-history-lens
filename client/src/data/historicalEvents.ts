...
const ALL_EVENTS: HistoricalEvent[] = [
  ...
  { id:"mj9", title:"Russo-Japanese War", year:"1904-1905", period:"1904-1905", category:"military", description:"Japan defeated Imperial Russia and shocked global observers, showing the reach of its modern army and navy.", sources:["Treaty of Portsmouth","British observer reports"], tags:["great-power rivalry","naval war"], topicId:"meiji", details:{ background:"Japanese and Russian ambitions collided over influence in Northeast Asia and Korea.", process:"Japanese forces won a series of land and naval campaigns, capped by the destruction of Russia's Baltic Fleet at Tsushima.", consequence:"Japan emerged as a major power, while the victory strengthened militarist confidence at home." } },
  ...
  { id:"korean_war-8", title:"Korean Armistice Agreement signed", year:"1953", period:"1953-07", category:"politics", description:"Delegates signed the Korean Armistice Agreement at Panmunjom, fixing the military demarcation line and creating the demilitarized zone.", sources:["Korean Armistice Agreement","United Nations General Assembly Resolution 498"], tags:["armistice","DMZ","Panmunjom"], topicId:"korean_war", details:{ background:"After two years of positional fighting, the belligerents faced mounting military and political pressure to stop active combat.", process:"Negotiators settled the demarcation line, prisoner-repatriation arrangements, and mechanisms for supervising the ceasefire.", consequence:"The war stopped without a peace treaty, leaving the peninsula divided and heavily militarized." } },
  // ===== 蒙古帝国的扩张 =====
...
export const ARCHIVE_TOPICS: ArchiveTopic[] = [
  ...
  { id:"korean_war", title:"Korean War", subtitle:"Cold War conflict and peninsula division", period:"1950-1953", region:"Korean Peninsula", description:"A Cold War conflict whose causes, conduct, and memory are interpreted differently by regional and international actors.", coverImage:"/images/korean_war-cover.jpg", caseId:"KW-1950", events: ALL_EVENTS.filter(e => e.topicId === "korean_war") },
  { id:"mongol_empire", title:"Mongol Empire Expansion", subtitle:"Steppe power and Eurasian transformation", period:"1206-1368", region:"Eurasia", description:"The rapid rise of a steppe empire reshaped Eurasian diplomacy, warfare, trade, and cross-cultural exchange.", coverImage:"/images/mongol_empire-cover.jpg", caseId:"MGE-1206-1368", events: ALL_EVENTS.filter(e => e.topicId === "mongol_empire") },
