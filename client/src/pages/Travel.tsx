...
const ROUTES: Record<string, RouteData> = {
  ...
  changchun_architecture: { title: "长春：伪满建筑群探索", duration: "1日", stops: [
    ...
    { time: "14:00", title: "新民大街八大部", type: "徒步", desc: "伪满八大政府机构建筑一线排列", img: "/images/hero-bg.jpg" },
    { time: "16:00", title: "伪满综合法衙旧址", type: "补充", desc: "殖民司法体系遗迹与建筑印记", img: "/images/hero-bg.jpg" },
  ]},
  changchun_resistance: { title: "长春：抗战记忆与解放", duration: "1日", stops: [
    { time: "09:00", title: "东北沦陷史陈列馆", type: "核心", desc: "十四年东北沦陷全景展览基地", img: "/images/hero-bg.jpg" },
    { time: "11:00", title: "长春电影制片厂旧址", type: "补充", desc: "伪满映画株式会社文化殖民见证", img: "/images/hero-bg.jpg" },
    { time: "14:00", title: "解放纪念碑", type: "核心", desc: "1948长春围城战纪念地标", img: "/images/hero-bg.jpg" },
  ...
  changchun_culture: { title: "长春：多元文化印记", duration: "1日", stops: [
    { time: "09:00", title: "般若寺", type: "核心", desc: "长春最古老佛寺，多民族信仰交融", img: "/images/hero-bg.jpg" },
    { time: "11:00", title: "伪满皇宫同德殿", type: "补充", desc: "中日文化碰撞空间，混合装饰风格", img: "/images/hero-bg.jpg" },
    { time: "14:00", title: "南湖公园", type: "徒步", desc: "日本规划的市民公园殖民生活缩影", img: "/images/hero-bg.jpg" },
    { time: "16:00", title: "长春站旧址", type: "补充", desc: "日俄铁路竞争产物多元建筑交汇", img: "/images/hero-bg.jpg" },
  ]},
  // ===== 巴黎 =====
  paris_architecture: { title: "巴黎：革命建筑巡礼", duration: "1日", stops: [
    ...
    { time: "16:00", title: "卡尔纳瓦雷博物馆", type: "补充", desc: "巴黎历史博物馆大革命实物珍藏", img: "/images/hero-bg.jpg" },
  ]},
  paris_revolution: { title: "巴黎：大革命全程追踪", duration: "1日", stops: [
    ...
    { time: "12:00", title: "杜伊勒里花园", type: "徒步", desc: "路易十六被押回王权终结舞台", img: "/images/hero-bg.jpg" },
    ...
    { time: "16:00", title: "拉雪兹公墓社员墙", type: "补充", desc: "巴黎公社最后战斗与牺牲之地", img: "/images/hero-bg.jpg" },
  ]},
  // ===== 柏林 =====
  berlin_architecture: { title: "柏林：冷战建筑遗产", duration: "1日", stops: [
    ...
    { time: "11:00", title: "查理检查站", type: "补充", desc: "冷战东西柏林最著名过境检查点", img: "/images/hero-bg.jpg" },
    { time: "13:30", title: "东边画廊", type: "徒步", desc: "1.3公里墙面涂鸦兄弟之吻名作", img: "/images/hero-bg.jpg" },
    { time: "15:30", title: "德国间谍博物馆", type: "补充", desc: "冷战间谍战互动体验情报战面貌", img: "/images/hero-bg.jpg" },
  ]},
  berlin_revolution: { title: "柏林：从分裂到统一", duration: "1日", stops: [
    ...
    { time: "11:00", title: "国会大厦", type: "核心", desc: "魏玛到统一德国民主曲折路见证", img: "/images/hero-bg.jpg" },
    ...
    { time: "16:00", title: "恐怖地形图", type: "补充", desc: "盖世太保总部遗址极权暴力档案", img: "/images/hero-bg.jpg" },
  ]},
  // ===== 西安 =====
  xian_architecture: { title: "西安：丝路起点古建巡礼", duration: "1日", stops: [
    ...
    { time: "11:30", title: "西安碑林博物馆", type: "核心", desc: "景教碑珍贵石刻丝路宗教传播录", img: "/images/hero-bg.jpg" },
    { time: "14:00", title: "大唐西市遗址", type: "核心", desc: "唐代国际贸易中心丝路商贸始发", img: "/images/hero-bg.jpg" },
    { time: "16:00", title: "陕西历史博物馆", type: "补充", desc: "丝路金银器唐三彩东西交流实证", img: "/images/hero-bg.jpg" },
  ]},
  xian_trade: { title: "西安：丝绸贸易线路追踪", duration: "1日", stops: [
    { time: "09:00", title: "陕西历史博物馆", type: "核心", desc: "丝路文物精华荟萃千年商贸见证", img: "/images/hero-bg.jpg" },
    { time: "11:30", title: "大唐西市遗址", type: "核心", desc: "胡商云集之地国际贸易黄金时代", img: "/images/hero-bg.jpg" },
    { time: "14:00", title: "回民街", type: "徒步", desc: "丝路饮食活化石千年胡食传承今", img: "/images/hero-bg.jpg" },
    { time: "16:00", title: "大明宫遗址公园", type: "补充", desc: "万国来朝帝国中心丝路政治起点", img: "/images/hero-bg.jpg" },
  ]},
  // ===== 波士顿 =====
  boston_architecture: { title: "波士顿：独立革命遗产", duration: "1日", stops: [
    { time: "09:00", title: "自由之路", type: "核心", desc: "4公里红砖路串联16处革命遗址", img: "/images/hero-bg.jpg" },
    { time: "11:00", title: "旧南会堂", type: "补充", desc: "波士顿惨案发生地独立运动火索", img: "/images/hero-bg.jpg" },
    { time: "13:30", title: "波士顿茶党博物馆", type: "核心", desc: "1773倾茶事件无代表不纳税起点", img: "/images/hero-bg.jpg" },
    { time: "15:30", title: "邦克山纪念碑", type: "补充", desc: "独立战争首次大战美国精神象征", img: "/images/hero-bg.jpg" },
  ]},
  boston_revolution: { title: "波士顿：革命先驱足迹", duration: "1日", stops: [
    { time: "09:00", title: "法尼尔厅", type: "核心", desc: "自由的摇篮亚当斯慷慨演说处", img: "/images/hero-bg.jpg" },
    { time: "11:00", title: "老北教堂", type: "核心", desc: "保罗里维尔夜骑信号灯起始之地", img: "/images/hero-bg.jpg" },
    { time: "14:00", title: "波士顿港茶党博物馆", type: "核心", desc: "互动还原倾茶之夜革命精神体验", img: "/images/hero-bg.jpg" },
    { time: "16:00", title: "邦克山战场", type: "补充", desc: "看见敌人的眼白才开枪的战场", img: "/images/hero-bg.jpg" },
  ]},
  // ===== 广州 =====
  guangzhou_trade: { title: "广州：海上贸易千年史", duration: "1日", stops: [
    { time: "09:00", title: "十三行博物馆", type: "核心", desc: "清代唯一通商口岸中西贸易起点", img: "/images/hero-bg.jpg" },
    { time: "11:30", title: "黄埔古港", type: "核心", desc: "海上丝路重要港口古代贸易见证", img: "/images/hero-bg.jpg" },
    { time: "14:00", title: "沙面岛", type: "徒步", desc: "英法租界150栋欧式建筑殖民印记", img: "/images/hero-bg.jpg" },
    { time: "16:00", title: "南越王墓博物馆", type: "补充", desc: "两千年前海丝起点舶来品实证", img: "/images/hero-bg.jpg" },
  ]},
  guangzhou_resistance: { title: "广州：鸦片战争抗争之路", duration: "1日", stops: [
    { time: "09:00", title: "虎门海战博物馆", type: "核心", desc: "林则徐虎门销烟遗址战争导火索", img: "/images/hero-bg.jpg" },
    { time: "11:30", title: "三元里抗英纪念馆", type: "核心", desc: "中国近代第一次自发抗击外侵", img: "/images/hero-bg.jpg" },
    { time: "14:00", title: "十三行博物馆", type: "补充", desc: "贸易垄断与走私鸦片冲突经济根源", img: "/images/hero-bg.jpg" },
    { time: "16:00", title: "沙面岛", type: "徒步", desc: "不平等条约产物租界屈辱与抗争", img: "/images/hero-bg.jpg" },
  ]},
  // ===== 敦煌 =====
  dunhuang_architecture: { title: "敦煌：石窟艺术朝圣", duration: "1日", stops: [
    ...
    { time: "12:30", title: "敦煌博物馆", type: "补充", desc: "丝路文物精品商路枢纽历史全貌", img: "/images/hero-bg.jpg" },
    { time: "14:30", title: "阳关遗址", type: "核心", desc: "西出阳关无故人古丝路西行关口", img: "/images/hero-bg.jpg" },
    { time: "17:00", title: "鸣沙山月牙泉", type: "补充", desc: "丝路旅人传说中的沙漠绿洲奇观", img: "/images/hero-bg.jpg" },
  ]},
  dunhuang_trade: { title: "敦煌：丝路商贸探秘", duration: "1日", stops: [
    { time: "08:30", title: "敦煌博物馆", type: "核心", desc: "汉简丝帛展示丝路贸易繁盛景象", img: "/images/hero-bg.jpg" },
    { time: "11:00", title: "玉门关遗址", type: "核心", desc: "春风不度玉门关丝路北线必经关", img: "/images/hero-bg.jpg" },
    { time: "14:00", title: "阳关遗址", type: "核心", desc: "丝路南线关口古代海关与驿站址", img: "/images/hero-bg.jpg" },
    { time: "16:30", title: "沙洲古城遗址", type: "补充", desc: "唐代丝路重镇东西方商队交汇点", img: "/images/hero-bg.jpg" },
  ]},
  // ===== 曼彻斯特 =====
  manchester_industry: { title: "曼彻斯特：工业革命心脏", duration: "1日", stops: [
    { time: "09:00", title: "科学与工业博物馆", type: "核心", desc: "世界首座客运火车站蒸汽时代展", img: "/images/hero-bg.jpg" },
    { time: "11:30", title: "恩格斯故居", type: "核心", desc: "英国工人阶级状况写作背景地", img: "/images/hero-bg.jpg" },
    { time: "14:00", title: "卡斯尔菲尔德", type: "徒步", desc: "运河铁路交汇工业交通网络起点", img: "/images/hero-bg.jpg" },
    { time: "16:00", title: "人民历史博物馆", type: "补充", desc: "宪章运动工会史工人阶级抗争录", img: "/images/hero-bg.jpg" },
  ]},
  manchester_revolution: { title: "曼彻斯特：劳工运动之路", duration: "1日", stops: [
    { time: "09:00", title: "圣彼得广场", type: "核心", desc: "1819彼得卢屠杀民主运动里程碑", img: "/images/hero-bg.jpg" },
    { time: "11:00", title: "人民历史博物馆", type: "核心", desc: "卢德运动到工党工人权利斗争史", img: "/images/hero-bg.jpg" },
    { time: "14:00", title: "切塔姆图书馆", type: "补充", desc: "马克思恩格斯研读处共产主义萌芽", img: "/images/hero-bg.jpg" },
    { time: "16:00", title: "自由贸易大厅", type: "补充", desc: "反谷物法运动中心自由贸易理念源", img: "/images/hero-bg.jpg" },
  ]},
  // ===== 里斯本 =====
  lisbon_trade: { title: "里斯本：大航海贸易帝国", duration: "1日", stops: [
    ...
    { time: "11:00", title: "贝伦塔", type: "补充", desc: "航海者最后望见的塔海上帝国守卫", img: "/images/hero-bg.jpg" },
    { time: "13:30", title: "热罗尼莫斯修道院", type: "核心", desc: "达伽马长眠处曼努埃尔建筑巅峰", img: "/images/hero-bg.jpg" },
    { time: "15:30", title: "国家马车博物馆", type: "补充", desc: "殖民帝国奢华展示航海财富象征", img: "/images/hero-bg.jpg" },
  ]},
  // ===== 萨拉热窝 =====
  sarajevo_architecture: { title: "萨拉热窝：三大帝国建筑", duration: "1日", stops: [
    { time: "09:00", title: "拉丁桥", type: "核心", desc: "斐迪南遇刺地一颗子弹引爆一战", img: "/images/hero-bg.jpg" },
    { time: "11:00", title: "萨拉热窝1878博物馆", type: "核心", desc: "奥匈帝国统治巴尔干民族主义兴起", img: "/images/hero-bg.jpg" },
    { time: "13:30", title: "巴什察尔希亚老城", type: "徒步", desc: "奥斯曼奥匈南斯拉夫三文明交汇", img: "/images/hero-bg.jpg" },
    { time: "15:30", title: "战争隧道博物馆", type: "补充", desc: "90年代围城战见证历史在此重演", img: "/images/hero-bg.jpg" },
  ]},
  // ===== 南京 =====
  nanjing_architecture: { title: "南京：百年政权更迭建筑", duration: "1日", stops: [
    { time: "09:00", title: "总统府", type: "核心", desc: "两江总督到民国政府百年政权更迭", img: "/images/hero-bg.jpg" },
    { time: "11:00", title: "中山陵", type: "核心", desc: "孙中山长眠共和理想永恒纪念碑", img: "/images/hero-bg.jpg" },
    { time: "14:00", title: "静海寺", type: "核心", desc: "近代第一个不平等条约南京条约址", img: "/images/hero-bg.jpg" },
    { time: "16:00", title: "明孝陵", type: "补充", desc: "明太祖陵墓六百年帝制建筑巅峰", img: "/images/hero-bg.jpg" },
  ]},
  nanjing_resistance: { title: "南京：铭记与和平", duration: "1日", stops: [
    { time: "09:00", title: "南京大屠杀纪念馆", type: "核心", desc: "铭记历史珍惜和平三十万同胞", img: "/images/hero-bg.jpg" },
    { time: "11:30", title: "拉贝故居", type: "核心", desc: "南京的辛德勒国际友人人道救援", img: "/images/hero-bg.jpg" },
    { time: "14:00", title: "总统府", type: "补充", desc: "太平天国到民国民族命运转折点", img: "/images/hero-bg.jpg" },
    { time: "16:00", title: "雨花台烈士陵园", type: "补充", desc: "革命先烈就义之地信仰牺牲象征", img: "/images/hero-bg.jpg" },
  ]},
  // ===== 东京 =====
  tokyo_architecture: { title: "东京：明治维新遗产", duration: "1日", stops: [
    { time: "09:00", title: "江户东京博物馆", type: "核心", desc: "幕府到维新400年变迁完整呈现", img: "/images/hero-bg.jpg" },
    { time: "11:30", title: "明治神宫", type: "补充", desc: "明治天皇纪念神社维新象征意义", img: "/images/hero-bg.jpg" },
    { time: "14:00", title: "靖国神社与游就馆", type: "核心", desc: "争议性战争叙事需批判性参观", img: "/images/hero-bg.jpg" },
    { time: "16:00", title: "东京国立博物馆", type: "补充", desc: "亚洲最大博物馆封建到现代文物", img: "/images/hero-bg.jpg" },
  ]},
  tokyo_revolution: { title: "东京：从封建到现代", duration: "1日", stops: [
    { time: "09:00", title: "皇居外苑", type: "核心", desc: "德川幕府权力中心旧制度终结地", img: "/images/hero-bg.jpg" },
    { time: "11:00", title: "明治神宫", type: "核心", desc: "维新之父的神化天皇制现代重塑", img: "/images/hero-bg.jpg" },
    { time: "14:00", title: "上野公园博物馆群", type: "徒步", desc: "西化空间实验博物馆美术馆聚集", img: "/images/hero-bg.jpg" },
    { time: "16:00", title: "浅草寺", type: "补充", desc: "东京最古老寺院传统与现代交汇", img: "/images/hero-bg.jpg" },
  ]},
};
        ...
        <div className="lg:col-span-4 space-y-8">
          ...
          <div className="bg-secondary/30 border-2 border-border p-6">
            ...
            <div className="aspect-video bg-background border border-border mb-4 relative overflow-hidden">
              <img src="/images/archive-texture.jpg" alt="AR Demo" className="w-full h-full object-cover opacity-50" />
